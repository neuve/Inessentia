...
export const posts: PostEntry[] = [
  ...
  },
  {
    ...
    es: { title: 'Sistemas Familiares Internos (IFS): conocer las partes que te habitan', description: 'Descubre cómo Internal Family Systems promueve el autoconocimiento compasivo desde la propuesta del trabajo con partes de tu experiencia interna, fortaleciendo al ego sano, la auto observación y dando lugar a la expresión creativa y la postura madura que hay en ti.', category: 'Aproximaciones terapéuticas', disqusIdentifier: '/blog-sistemas-familiares-internos.html' },
    en: { title: 'Internal Family Systems (IFS): getting to know the parts that live in you', description: 'Discover how Internal Family Systems promotes compassionate self-knowledge through working with the parts of your inner experience, strengthening the healthy ego and self-observation, and making room for the creative expression and mature stance already within you.', category: 'Therapeutic approaches', disqusIdentifier: '/en/blog-internal-family-systems.html' },
    next: 'tapping-eft',
  },
  {
    id: 'tapping-eft',
  ...
  },
  {
    ...
    heroPosition: 'center 25%',
    es: { title: 'Muchas puertas de entrada: las aproximaciones que integro en consulta', description: 'Un sobrevuelo de las aproximaciones que integro —Experiencia Somática, IFS, Tapping/EFT, Core Energética y terapia corporal— y cómo elijo entre ellas siguiendo el ritmo de tu experiencia. Con enlaces para profundizar en cada una.', category: 'Aproximaciones terapéuticas', disqusIdentifier: '/blog-tipos-de-terapia.html' },
    en: { title: 'Many ways in: the approaches I integrate in session', description: 'A flyover of the approaches I integrate — Somatic Experiencing, IFS, Tapping/EFT, Core Energetics, and body-based therapy — and how I choose among them by following the rhythm of your experience. With links to go deeper into each.', category: 'Therapeutic approaches', disqusIdentifier: '/en/blog-types-of-therapy.html' },
    next: null,
  },
];
